...
const Skills2026 = () => {
  ...
  const skillIcons = {
    ...
    'Next.js': <SiNextdotjs className="text-[var(--text-primary)]" />,
    ...
    'Express JS': <SiExpress className="text-[var(--text-primary)]" />,
    ...
    'Socket.io': <SiSocketdotio className="text-[var(--text-primary)]" />,
  ...
  const getIcon = (skillName) => {
    ...
    return skillIcons[cleanName] || <FaCode className="text-[var(--accent-primary)]" />;
  };
  ...
  return (
    <div
      id="skills"
      ref={ref}
      className="relative min-h-screen py-24 px-4 overflow-hidden bg-[var(--bg-primary)]"
    >
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <FaCode className="text-[var(--accent-primary)]" />
          ...
          <p className="text-lg sm:text-xl max-w-3xl mx-auto text-[var(--text-secondary)]">
        ...
        >
          <div className="glass-card rounded-2xl p-8 sm:p-12 max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg mb-8 text-[var(--text-secondary)]">
